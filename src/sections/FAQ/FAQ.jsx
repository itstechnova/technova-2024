      ...
      <div className="faq-questions">
        <div className="faq-left-col">
          ...
          <ExpandableCard question={"How do teams work?"}>
            Teams can consist of up to 4 hackers. You can apply with or without a team and we will set you up with one!  There will be plenty of opportunities to connect with your teammates and others during the hackathon.
          </ExpandableCard>
